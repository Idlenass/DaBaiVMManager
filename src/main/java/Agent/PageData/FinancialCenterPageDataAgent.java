...
public class FinancialCenterPageDataAgent {
    ...
    public FinancialCenterPageDataAgent() {
    }

    public String getFinancialCenterPageDataJsonStringBySessionkey(String sessionkey){
